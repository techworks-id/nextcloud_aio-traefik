...
if [[ "$response" =~ ^([yY][eE][sS]|[yY])$ ]] ; then
    ...
    echo "Your Nextcloud data is saved using this environment: "NEXTCLOUD_DATADIR: /mnt/ncdata""
    echo "If you want to deploy nextcloud-aio again remove /mnt/ncdata or use other path before running setup.sh"
else
    echo "Ok then. :D"
fi
